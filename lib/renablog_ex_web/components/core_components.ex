defmodule RenablogExWeb.CoreComponents do
  @moduledoc """
  ...
  def translate_error({msg, opts}) do
    ...
    if count = opts[:count] do
      Gettext.dngettext(RenablogExWeb.Gettext, "errors", msg, msg, count, opts)
    else
      Gettext.dgettext(RenablogExWeb.Gettext, "errors", msg, opts)
    end
  end
